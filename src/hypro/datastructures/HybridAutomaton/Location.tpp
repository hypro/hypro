...
template<typename Number>
Location<Number>::Location(unsigned _id, const hydra::Location& _loc)
...
template<typename Number>
Location<Number>::Location(unsigned _id, const hypro::matrix_t<Number>& _mat, const hydra::Location<Number>::transitionSet& _trans, const Condition& _inv)
    : mFlow(_mat), mExternalInput(), mTransitions(_trans), mInvariant(_inv), mId(_id)
{
}

template<typename Number>
Location<Number>::Location(unsigned _id, const hypro::matrix_t<Number>& _mat, const hydra::Location::transitionSet& _trans, const Condition& _inv,
