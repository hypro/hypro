...
template<typename Number>
Location<Number> *LocationManager<Number>::create(const hypro::matrix_t<Number> _mat, const typename Location<Number>::transitionSet _trans, const Condition& _inv)
{
