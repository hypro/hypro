function [reachabilityTime, verificationTime, time, safe] = rr_no_gc(saveFig, savePath, figName, bad, diff,settings,setRepr,aggr, plotting)
...
guard2.setMatrix([1 0 0; -1 0 0; 0 -1 0]);
...
guard3.setMatrix([1 0 0; -1 0 0; 0 0 -1]);
