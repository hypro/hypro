...
void MLabel::getName(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[]){
    if(nlhs != 1)
        mexErrMsgTxt("MLabel - getName: Expecting an output.");
    if(nrhs < 3)
        mexErrMsgTxt("MLabel - getName: One or more arguments are missing.");
    if(nrhs > 3)
        mexWarnMsgTxt("MLabel - getName: One or more arguments were ignored.");
...
void MLabel::setName(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[]){
    if(nrhs < 4)
        mexErrMsgTxt("MLabel - setName: One or more arguments are missing.");
    if(nrhs > 4)
        mexWarnMsgTxt("MLabel - setName: One or more arguments were ignored.");
...
void MLabel::equals(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[]){
    if(nlhs != 1)
        mexErrMsgTxt("MLabel - equals: Expecting an output.");
    if(nrhs < 4)
        mexErrMsgTxt("MLabel - equals: One or more arguments are missing.");
    if(nrhs > 4)
        mexWarnMsgTxt("MLabel - equals: One or more arguments were ignored.");
...
void MLabel::unequals(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[]){
    if(nlhs != 1)
        mexErrMsgTxt("MLabel - unequals: Expecting an output.");
    if(nrhs < 4)
        mexErrMsgTxt("MLabel - unequals: One or more arguments are missing.");
    if(nrhs > 4)
        mexWarnMsgTxt("MLabel - unequals: One or more arguments were ignored.");
...
void MLabel::less(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[]){
    if(nlhs != 1)
        mexErrMsgTxt("MLabel - less: Expecting an output.");
    if(nrhs < 4)
        mexErrMsgTxt("MLabel - less: One or more arguments are missing.");
    if(nrhs > 4)
        mexWarnMsgTxt("MLabel - less: One or more arguments were ignored.");
