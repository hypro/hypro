...
*/
template<class T>
void MReach<T>::del_reach(int lhs, mxArray* plhs[], int nrhs, const mxArray* prhs[]){
    if(nrhs < 3)
...
*/
template<class T>
void MReach<T>::new_reach(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[]){
    if(nlhs != 1)
...
*/
template<class T>
void MReach<T>::computeForwardReachability(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[]){
    if(nlhs != 1)
    ...
    std::vector<std::pair<unsigned, std::vector<hypro::State<double,T>>>> flowpipes = reacher->computeForwardReachability();
