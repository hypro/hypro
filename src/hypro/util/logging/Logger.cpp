...
int initializeLogging( int& i ) {
	...
	carl::logging::logger().filter( "logfile_hypro" )( "hypro", carl::logging::LogLevel::LVL_INFO )( "hypro.reachability", carl::logging::LogLevel::LVL_TRACE )( "hypro.representations", carl::logging::LogLevel::LVL_INFO )( "hypro.representations.supportFunction", carl::logging::LogLevel::LVL_INFO )( "hypro.representations.HPolytope", carl::logging::LogLevel::LVL_INFO )( "hypro.datastructures", carl::logging::LogLevel::LVL_INFO )( "hypro.reacher", carl::logging::LogLevel::LVL_TRACE )( "hypro.reacher.preprocessing", carl::logging::LogLevel::LVL_TRACE );
