...
#define __HYPRO_LOG(lvl,channel,expr) { std::stringstream __ss; __ss << std::this_thread::get_id() << " " << expr; carl::logging::Logger::getInstance().log(lvl, channel, __ss, carl::logging::RecordInfo{__FILE__,__func__,__LINE__});}
