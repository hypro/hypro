...
std::pair<CONTAINMENT, Representation> ltiIntersectBadStates( const Representation& valuationSet, Location<Number>* location, const HybridAutomaton<Number>& automaton ) {
