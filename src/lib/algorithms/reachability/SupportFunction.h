...
class SupportFunction {
  ...
  public:
	...
	*/
	artificialDirections* getAD() { return aD; }
...
ScalarMultiplicationSupportfunction* SupportFunction::multiply( double lhs ) {
	...
	ScalarMultiplicationSupportfunction* result =
		  new ScalarMultiplicationSupportfunction( lhs, this, this->getSupportFunctionType() );
	return result;
}
...
MultiplicationSupportfunction* SupportFunction::multiply( matrix_t<double> lhs ) {
	...
	MultiplicationSupportfunction* result =
		  new MultiplicationSupportfunction( lhs, this, this->getSupportFunctionType() );
	return result;
}
...
class ZeroSupportFunction : public SupportFunction {
  ...
  protected:
	evaluationResult specificEvaluation( matrix_t<double> l ) { return result; };
