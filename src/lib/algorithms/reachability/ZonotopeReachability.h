...
class ZonotopeReachability {
  ...
  private:  // private functions
	...
	bool runReachabilityAnalysis( unsigned int numIterations, unsigned int offset, hypro::scalar_t<Number> r_scalar,
								  unsigned int order_reduction_threshold, Zonotope<Number>& res_V,
								  Zonotope<Number>& res_S, const ZUtility::Options& option );
  ...
  public:  // public functions
	 ...
	 * @param order_reduction_threshold The threshold number of generators, from which we will overapproximate the
	 * generators
	 * @return true if reachability analysis was completed, false if reachability analysis was terminated prematurely
	 * due to unfulfilled conditions
	 */
	bool startReachabilityAnalysis( unsigned int numIterations, unsigned int offset, hypro::scalar_t<Number> r_scalar,
									unsigned int order_reduction_threshold, const ZUtility::Options& option );
};
