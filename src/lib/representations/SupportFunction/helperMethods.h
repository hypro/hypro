...
//             std::cout << "transition: " << i << " Number of intersection parts: " << t.sets.size() << std::endl << "set indices: ";
...
//    }
    ...
    */
    matrix_t<double> addZeroRow(matrix_t<double> m)
    {
         ...
         #ifdef HELPER_METHODS_VERBOSE
            std::cout<< "addZeroRow(m): m:" << std::endl << m << std::endl << "extended m: " << std::endl << result << std::endl;
         #endif
