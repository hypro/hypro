...
struct sumContent {
	...
	sumContent( std::shared_ptr<SupportFunction<Number>> _lhs, std::shared_ptr<SupportFunction<Number>> _rhs )
		: lhs( _lhs ), rhs( _rhs ) {}
...
struct trafoContent {
	...
	matrix_t<Number> a;
	vector_t<Number> b;
	trafoContent( std::shared_ptr<SupportFunction<Number>> _origin, matrix_t<Number> _a, vector_t<Number> _b )
...
struct scaleContent {
	std::shared_ptr<SupportFunction<Number>> origin;
	Number factor;
	scaleContent( std::shared_ptr<SupportFunction<Number>> _origin, Number _factor )
...
struct unionContent {
	std::shared_ptr<SupportFunction<Number>> lhs;
	std::shared_ptr<SupportFunction<Number>> rhs;
	unionContent( std::shared_ptr<SupportFunction<Number>> _lhs, std::shared_ptr<SupportFunction<Number>> _rhs )
		: lhs( _lhs ), rhs( _rhs ) {}
...
struct intersectionContent {
	std::shared_ptr<SupportFunction<Number>> lhs;
	std::shared_ptr<SupportFunction<Number>> rhs;
	intersectionContent( std::shared_ptr<SupportFunction<Number>> _lhs, std::shared_ptr<SupportFunction<Number>> _rhs )
		: lhs( _lhs ), rhs( _rhs ) {}
...
class SupportFunction {
  private:
	...
	SupportFunction( const matrix_t<Number>& _directions, const vector_t<Number>& _distances,
					 SF_TYPE _type = SF_TYPE::POLY );
	SupportFunction( const std::vector<Hyperplane<Number>>& _planes, SF_TYPE _type = SF_TYPE::POLY );
	SupportFunction( std::shared_ptr<SupportFunction<Number>> _lhs, std::shared_ptr<SupportFunction<Number>> _rhs,
					 SF_TYPE _type );
	SupportFunction( std::shared_ptr<SupportFunction<Number>> _origin, const matrix_t<Number>& _a,
					 const vector_t<Number>& _b, SF_TYPE _type );
	SupportFunction( std::shared_ptr<SupportFunction<Number>> _origin, const Number& _factor,
  ...
  public:
	...
	static std::shared_ptr<SupportFunction<Number>> create( SF_TYPE _type, const matrix_t<Number>& _directions,
															const vector_t<Number>& _distances ) {
		auto obj =
			  std::shared_ptr<SupportFunction<Number>>( new SupportFunction<Number>( _directions, _distances, _type ) );
		obj->pThis = obj;
		return obj;
	}

	static std::shared_ptr<SupportFunction<Number>> create( SF_TYPE _type,
	...
	std::shared_ptr<SupportFunction<Number>> linearTransformation( const matrix_t<Number>& _A,
