...
template<typename Number>
int Flowpipe<Number>::next_picard(Flowpipe<Number> & result, const PolynomialODE<Number> & ode, const Variable & t, const double stepsize, const exponent order, const Range<Number> & estimation)
{
...
template<typename Number>
ContinuousSystem<Number>::ContinuousSystem(const PolynomialODE<Number> & ode_input, const Flowpipe<Number> & initialSet_input)
{
	ode			= ode_input;
...
template<typename Number>
int ContinuousSystem<Number>::reach_picard(std::list<Flowpipe<Number>> & result, const Variable & t, const double time, const double stepsize, const exponent order, const Range<Number> & estimation) const
{
	result.clear();
...
template<typename Number>
void output_2D_interval_gnuplot(std::list<Flowpipe<Number> > & flowpipes, std::ofstream & os, const std::string & fileName, const Variable & axis_x, const Variable & axis_y)
{
