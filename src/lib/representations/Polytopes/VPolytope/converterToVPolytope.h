...
namespace hypro {
    ...
    static bool convert( const hypro::VPolytope<Number>& _source, hypro::VPolytope<Number>& _target, const CONV_MODE mode = CONV_MODE::OVER  );
     ...
     */  
    template <typename Number>
    static bool convert( const hypro::HPolytope<Number>& _source, hypro::VPolytope<Number>& _target, const CONV_MODE mode = CONV_MODE::OVER  );
     ...
     */  
    template <typename Number>
    static bool convert( const hypro::Box<Number>& _source, hypro::VPolytope<Number>& _target, const CONV_MODE mode = CONV_MODE::OVER  );
     ...
     */  
    template <typename Number>
    static bool convert( const hypro::Zonotope<Number>& _source, hypro::VPolytope<Number>& _target, const CONV_MODE mode = CONV_MODE::OVER  );   
     ...
     */  
    template <typename Number>
    static bool convert( const hypro::SupportFunction<Number>& _source, hypro::VPolytope<Number>& _target, const CONV_MODE mode = CONV_MODE::OVER  ); 
