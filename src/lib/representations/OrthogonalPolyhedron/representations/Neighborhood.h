...
namespace hypro {
    ...
    class OrthogonalPolyhedron
    {
        ...
        public:
            ...
            OrthogonalPolyhedron<Number, ORTHO_TYPE::NEIGHBORHOOD> linearTransformation(const matrix_t<Number>& A, const vector_t<Number>& b) const;
            OrthogonalPolyhedron<Number, ORTHO_TYPE::NEIGHBORHOOD> minkowskiSum(const OrthogonalPolyhedron<Number, ORTHO_TYPE::NEIGHBORHOOD>& rhs) const;
            OrthogonalPolyhedron<Number, ORTHO_TYPE::NEIGHBORHOOD> intersect(const OrthogonalPolyhedron<Number, ORTHO_TYPE::NEIGHBORHOOD>& rhs) const;
            ...
            OrthogonalPolyhedron<Number, ORTHO_TYPE::NEIGHBORHOOD>& operator= ( const OrthogonalPolyhedron<Number, ORTHO_TYPE::NEIGHBORHOOD>& _in ) = default;
            OrthogonalPolyhedron<Number, TyORTHO_TYPE::NEIGHBORHOODpe>& operator= ( OrthogonalPolyhedron<Number, ORTHO_TYPE::NEIGHBORHOOD>&& ) = default;

            friend bool operator==(const OrthogonalPolyhedron<Number, ORTHO_TYPE::NEIGHBORHOOD>& op1, const OrthogonalPolyhedron<Number, ORTHO_TYPE::NEIGHBORHOOD>& op2) {
            ...
            friend std::ostream& operator<<(std::ostream& ostr, const OrthogonalPolyhedron<Number, ORTHO_TYPE::NEIGHBORHOOD>& p) {
                ostr << "(";
