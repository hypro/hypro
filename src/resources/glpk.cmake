...
ExternalProject_Add(
    ...
    CONFIGURE_COMMAND ./configure --prefix=${CMAKE_SOURCE_DIR}/src/resources/glpk-${glpk_version}/install --with-gmp --with-pic CPPFLAGS=-fPIC --disable-shared --enable-static
	PREFIX ${CMAKE_SOURCE_DIR}/src/resources/glpk-${glpk_version}/install
            #BUILD_COMMAND make
            BUILD_IN_SOURCE 1
            INSTALL_DIR ${CMAKE_SOURCE_DIR}/src/resources/glpk-${glpk_version}/install
...
set( GLPK_INCLUDE_DIR "${CMAKE_SOURCE_DIR}/src/resources/glpk-${glpk_version}/install/include" PARENT_SCOPE )
set( GLPK_LIBRARIES "${CMAKE_SOURCE_DIR}/src/resources/glpk-${glpk_version}/install/lib/${CMAKE_FIND_LIBRARY_PREFIXES}glpk${CMAKE_STATIC_LIBRARY_SUFFIX}" PARENT_SCOPE )
