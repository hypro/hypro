...
ExternalProject_ADD(
  ...
  CONFIGURE_COMMAND  ${CMAKE_COMMAND} -DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER} -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_FLAGS=${CMAKE_CXX_FLAGS} -fPIC -DBUILD_SHARED_LIBS=ON -DBUILD_TESTS=OFF -DCMAKE_INSTALL_PREFIX:PATH=<INSTALL_DIR> -DCMAKE_SOURCE_DIR:PATH=<SOURCE_DIR> -DWITH_DEMO=False -DWITH_LIBCXX=False <SOURCE_DIR>
  LOG_CONFIGURE ON
  #--Build step-----------------
...
set(ANTLR4CPP_STATIC_LIBS "${INSTALL_DIR}/lib/libantlr4-runtime${CMAKE_STATIC_LIBRARY_SUFFIX}")
set(ANTLR4CPP_SHARED_LIBS "${INSTALL_DIR}/lib/libantlr4-runtime${CMAKE_SHARED_LIBRARY_SUFFIX}")
...
add_imported_library(ANTLR4 STATIC "${INSTALL_DIR}/lib/${CMAKE_FIND_LIBRARY_PREFIXES}antlr4-runtime${CMAKE_STATIC_LIBRARY_SUFFIX}" ${ANTLR4CPP_INCLUDE_DIRS})
add_imported_library(ANTLR4 SHARED "${INSTALL_DIR}/lib/${CMAKE_FIND_LIBRARY_PREFIXES}antlr4-runtime${CMAKE_SHARED_LIBRARY_SUFFIX}" ${ANTLR4CPP_INCLUDE_DIRS})
