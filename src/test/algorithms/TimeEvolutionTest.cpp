...
#include <algorithms/reachability/handlers/timeEvolutionHandlers/linearTimeEvolutionHandler.h>
...
TEST( TimeEvolutionTest, SingularEvolution ) {
	...
	auto unbndTimeEvolution = hypro::linearApplyTimeEvolution( init, dynamicsPoly1 );
	...
	auto bndTimeEvolution = hypro::linearApplyBoundedTimeEvolution( init2, dynamicsPoly1, hypro::tNumber( 10 ) );
