...
protected:
    ...
    HierarchicalIntervalVector<CONTAINMENT,mpq_class> hivPlain = HierarchicalIntervalVector<CONTAINMENT,mpq_class>{order};
    HierarchicalIntervalVector<CONTAINMENT,mpq_class> hiv1 = HierarchicalIntervalVector<CONTAINMENT,mpq_class>{order};
};
