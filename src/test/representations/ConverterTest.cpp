...
TYPED_TEST( ConverterTest, toSupportFunctionNew ) {
	// auto result = Converter<TypeParam>::toSupportFunctionNew(this->zonotope); //COMMENTED OUT SINCE ZONOTOPE HAVE NO
	// MATRIX AND VECTOR FUNCTION
	auto result2 = Converter<TypeParam>::toSupportFunctionNew( this->box );
	// auto result3 = Converter<TypeParam>::toSupportFunctionNew(this->vpolytope); //COMMENTED OUT SINCE VPOLYS HAVE NO
	// MATRIX AND VECTOR FUNCTION auto result4 = Converter<TypeParam>::toSupportFunctionNew(this->vpolytope2);
