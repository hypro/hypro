...
\visible<2,3>{\begin{tabular}{| c | c || c c |}
	\hline	
	$s_1$ & $y$ & & \\
	\hline
	\hline	
...
\end{column}
\begin{column}{5cm}
\only<1>{\includegraphics[width=4cm]{images/cone1.eps}}
\only<2>{\includegraphics[width=4cm]{images/cone2.eps}}
\only<3>{\includegraphics[width=4cm]{images/cone3.eps}}
\only<4>{\includegraphics[width=4cm]{images/cone4.eps}}
\end{column}
\end{columns}
