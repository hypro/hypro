...
\begin{figure}
\caption{On the right: the evolution of the temperature for the given thermostat initialized on the state (ON,$20$\textdegree C). On the left: the corresponding hybrid automata.}
