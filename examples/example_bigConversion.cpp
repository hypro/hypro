...
int main(int argc, char const *argv[])
{
	typedef mpq_class Number;
        ...
        std::cout << "FINISHED CONSTRUCTION OF HPOLYTOPE TEMPLATED." << std::endl;
        ...
        std::cout << "CONVERT TO VPOLY" << std::endl;
        vpolytope = Converter<Number>::toVPolytope(hpolytope);
        std::cout << "CONVERT TO VPOLY -------- DONE" << std::endl;
        ...
        std::cout << "CONVERT TO SF" << std::endl;
        support = Converter<Number>::toSupportFunction(hpolytope);
        std::cout << "CONVERT TO SF -------- DONE" << std::endl;
