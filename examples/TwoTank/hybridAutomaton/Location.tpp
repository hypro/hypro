...
namespace hypro {
	...
	hypro::matrix_t<Number> Location<Number>::activityMat() {
        ...
        template<typename Number>
        hypro::matrix_t<Number> Location<Number>::activityInputMat() {
            return mLocation.input_mat;
        }
	...
	void Location<Number>::setActivityMat(hypro::matrix_t<Number> _mat) {
        ...
        template<typename Number>
        void Location<Number>::setActivityInputMat(hypro::matrix_t<Number> _inputMat) {
            mLocation.input_mat = _inputMat;
        }
