...
int main(int argc, char** argv) {
	...
	*/
	...
	shift << Number(-762609227)/Number(1554758872579),Number(-357301353556)/Number(3642215632579);
...
//	//linearMap = linearMap*timestep;
	...
	*/
	...
	std::vector<EvaluationResult<Number>> elli1Eval = elli1.multiEvaluate(evaldirections);
	std::vector<EvaluationResult<Number>> elli2Eval = elli2.multiEvaluate(evaldirections);
	std::vector<EvaluationResult<Number>> minkEval = mink.multiEvaluate(evaldirections);
	std::vector<EvaluationResult<Number>> mink2Eval = mink2.multiEvaluate(evaldirections);
