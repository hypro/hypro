...
q1Mat(0,0) = Number(-0.8047);
q1Mat(0,1) = Number(+8.7420);
q1Mat(0,2) = Number(-2.4591);
q1Mat(0,3) = Number(-8.2714);
q1Mat(0,4) = Number(-1.8640);
q1Mat(0,5) = Number(-0.0845);

q1Mat(1,0) = Number(-8.6329);
q1Mat(1,1) = Number(-0.5860);
q1Mat(1,2) = Number(-2.1006);
q1Mat(1,3) = Number(+3.6035);
q1Mat(1,4) = Number(-1.8423);

q1Mat(2,0) = Number(2.4511);
q1Mat(2,1) = Number(+2.2394);
q1Mat(2,2) = Number(-0.7538);
q1Mat(2,3) = Number(-3.6934);
q1Mat(2,4) = Number(+2.4585);

q1Mat(3,0) = Number(8.3858);
q1Mat(3,1) = Number(-3.1739);
q1Mat(3,2) = Number(+3.7822);
q1Mat(3,3) = Number(-0.6249);
q1Mat(3,4) = Number(+1.8829);

q1Mat(4,0) = Number(1.8302);
q1Mat(4,1) = Number(+1.9869);
q1Mat(4,2) = Number(-2.4539);
q1Mat(4,3) = Number(-1.7726);
q1Mat(4,4) = Number(-0.7911);
q1Mat(4,5) = Number(-0.0845);


q2Mat(0,0) = Number(-0.8316);
q2Mat(0,1) = Number(+8.7658);
q2Mat(0,2) = Number(-2.4744);
q2Mat(0,3) = Number(-8.2608);
q2Mat(0,4) = Number(-1.9033);
q2Mat(0,5) = Number(-0.0845);

q2Mat(1,0) = Number(-0.8316);
q2Mat(1,1) = Number(-0.5860);
q2Mat(1,2) = Number(-2.1006);
q2Mat(1,3) = Number(+3.6035);
q2Mat(1,4) = Number(-1.8423);

q2Mat(2,0) = Number(2.4511);
q2Mat(2,1) = Number(+2.2394);
q2Mat(2,2) = Number(-0.7538);
q2Mat(2,3) = Number(-3.6934);
q2Mat(2,4) = Number(+2.4585);

q2Mat(3,0) = Number(8.3858);
q2Mat(3,1) = Number(-3.1739);
q2Mat(3,2) = Number(+3.7822);
q2Mat(3,3) = Number(-0.6249);
q2Mat(3,4) = Number(+1.8829);

q2Mat(4,0) = Number(1.5964);
q2Mat(4,1) = Number(+2.1936);
q2Mat(4,2) = Number(-2.5872);
q2Mat(4,3) = Number(-1.6812);
q2Mat(4,4) = Number(-1.1324);
q2Mat(4,5) = Number(-0.7342);


q3Mat(0,0) = Number(-0.9275);
q3Mat(0,1) = Number(+8.8628);
q3Mat(0,2) = Number(-2.5428);
q3Mat(0,3) = Number(-8.2329);
q3Mat(0,4) = Number(-2.0324);
q3Mat(0,5) = Number(-0.0845);

q3Mat(1,0) = Number(-0.8316);
q3Mat(1,1) = Number(-0.5860);
q3Mat(1,2) = Number(-2.1006);
q3Mat(1,3) = Number(+3.6035);
q3Mat(1,4) = Number(-1.8423);

q3Mat(2,0) = Number(2.4511);
q3Mat(2,1) = Number(+2.2394);
q3Mat(2,2) = Number(-0.7538);
q3Mat(2,3) = Number(-3.6934);
q3Mat(2,4) = Number(+2.4585);

q3Mat(3,0) = Number(8.3858);
q3Mat(3,1) = Number(-3.1739);
q3Mat(3,2) = Number(+3.7822);
q3Mat(3,3) = Number(-0.6249);
q3Mat(3,4) = Number(+1.8829);

q3Mat(4,0) = Number(0.7635);
q3Mat(4,1) = Number(+3.0357);
q3Mat(4,2) = Number(-3.1814);
q3Mat(4,3) = Number(-1.4388);
q3Mat(4,4) = Number(-2.2538);
q3Mat(4,5) = Number(-0.7342);


q4Mat(0,0) = Number(-1.4021);
q4Mat(0,1) = Number(+10.1647);
q4Mat(0,2) = Number(-3.3937);
q4Mat(0,3) = Number(-8.5139);
q4Mat(0,4) = Number(-2.9602);
q4Mat(0,5) = Number(-0.0845);

q4Mat(1,0) = Number(-0.8316);
q4Mat(1,1) = Number(-0.5860);
q4Mat(1,2) = Number(-2.1006);
q4Mat(1,3) = Number(+3.6035);
q4Mat(1,4) = Number(-1.8423);

q4Mat(2,0) = Number(2.4511);
q4Mat(2,1) = Number(+2.2394);
q4Mat(2,2) = Number(-0.7538);
q4Mat(2,3) = Number(-3.6934);
q4Mat(2,4) = Number(+2.4585);

q4Mat(3,0) = Number(8.3858);
q4Mat(3,1) = Number(-3.1739);
q4Mat(3,2) = Number(+3.7822);
q4Mat(3,3) = Number(-0.6249);
q4Mat(3,4) = Number(+1.8829);

q4Mat(4,0) = Number(-3.3585);
q4Mat(4,1) = Number(+14.3426);
q4Mat(4,2) = Number(-10.5703);
q4Mat(4,3) = Number(-3.8785);
q4Mat(4,4) = Number(-10.3111);
q4Mat(4,5) = Number(-0.7342);


q5Mat(0,0) = Number(-1.4021);
q5Mat(0,1) = Number(+10.1647);
q5Mat(0,2) = Number(-3.3937);
q5Mat(0,3) = Number(-8.5139);
q5Mat(0,4) = Number(-2.9602);
q5Mat(0,5) = Number(-0.0845);

q5Mat(1,0) = Number(-0.8316);
q5Mat(1,1) = Number(-0.5860);
q5Mat(1,2) = Number(-2.1006);
q5Mat(1,3) = Number(+3.6035);
q5Mat(1,4) = Number(-1.8423);

q5Mat(2,0) = Number(2.4511);
q5Mat(2,1) = Number(+2.2394);
q5Mat(2,2) = Number(-0.7538);
q5Mat(2,3) = Number(-3.6934);
q5Mat(2,4) = Number(+2.4585);

q5Mat(3,0) = Number(8.3858);
q5Mat(3,1) = Number(-3.1739);
q5Mat(3,2) = Number(+3.7822);
q5Mat(3,3) = Number(-0.6249); 
q5Mat(3,4) = Number(+1.8829);

q5Mat(4,0) = Number(-3.3585);
q5Mat(4,1) = Number(+14.3426);
q5Mat(4,2) = Number(-10.5703);
q5Mat(4,3) = Number(-3.8785);
q5Mat(4,4) = Number(-10.3111);
q5Mat(4,5) = Number(-0.7342);
  ...
  t12GuardVec(0) = Number(3.01);
	t12GuardMat(0,1) = Number(1);
	t23GuardVec(0) = Number(2.01);
	t23GuardMat(0,1) = Number(1);
	t34GuardVec(0) = Number(1.01);
	t34GuardMat(0,1) = Number(1);
	t45GuardVec(0) = Number(0.01);
	t45GuardMat(0,1) = Number(1);
	t51GuardVec(0) = Number(-0.99);
	t51GuardMat(0,1) = Number(-1);
  ...
  reset51.translationVec = assignVec;
	...
	boxVec(0) = Number(-3.09);
	boxVec(1) = Number(3.11);
	boxVec(2) = Number(-3.99);
	boxVec(3) = Number(4.01);
	boxVec(4) = Number(0.01); //Note: we want -0.01 <= x3,x4,x5 <= 0.01, so no sign here!
	boxVec(5) = Number(0.01);
	boxVec(6) = Number(0.01);
	boxVec(7) = Number(0.01);
	boxVec(8) = Number(0.01);
	boxVec(9) = Number(0.01);
	//boxVec(10) = Number(-1);
	//boxVec(11) = Number(1);
	...
	boxMat(8,4) = Number(-1);
	boxMat(9,4) = Number(1);
	//boxMat(10,5) = Number(-1);
	//boxMat(11,5) = Number(1);
