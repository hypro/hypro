...
std::cout << "------------------------------"<< std::endl;
  ...
  // start timer
    ...
    + (x1 * carl::pow(x1,2)) * x1_4 + carl::pow(x1,2) * x1_1 - (x1 * x1) * x1_5 - carl::pow(x1,2) * x1_6 
  ...
  // start timer
	gettimeofday(&t1, NULL);
	carl::Interval<Number> res6 = (carl::pow(x2,4) + carl::pow(x2,4) * x2_1) + (carl::pow(x2,2) - carl::pow(x2,2)) * x2_2
  ...
  // start timer
    ...
    + carl::pow(x1, 2) * x4_2 * (carl::pow(x1,2) + carl::pow(x1,2)) - (carl::pow(x1,2) + carl::pow(x1,2) + carl::pow(x1,2)) * x4_3
    + x4_2;
	// stop timer
	gettimeofday(&t2, NULL);
