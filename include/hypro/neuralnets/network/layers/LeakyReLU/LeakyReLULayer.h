...
class LeakyReLULayer : public LayerBase<Number> {
  private:
	 ...
	 */
	std::vector<hypro::Starset<Number>> reachLeakyReLU( const hypro::Starset<Number>& input_star1, NN_REACH_METHOD method, bool plot_intermediates ) const;
  ...
  public:
	 ...
	 */
	  ...
	  */
	  LeakyReLULayer( unsigned short int layerSize, unsigned short int layerIndex, float negativeSlope);
	   ...
	   */
	   ...
	   virtual void serialize( std::ostream& os ) const {
		   ...
		   os << "LeakyReLU negative slope " << this->mMinValue << std::endl;
	   }
};
}// namespace hypro
