...
template <typename Number>
std::vector<hypro::Starset<Number>> ReachNN<Number>::stepReLU( int i, std::vector<hypro::Starset<Number>>& input_sets ) const {
	std::vector<hypro::Starset<Number>> result = std::vector<hypro::Starset<Number>>();
...
template <typename Number>
std::vector<hypro::Starset<Number>> ReachNN<Number>::approxStepReLU( int i, std::vector<hypro::Starset<Number>>& input_sets ) const {
	std::vector<hypro::Starset<Number>> result = std::vector<hypro::Starset<Number>>();
	int k = input_sets.size();
	for ( int j = 0; j < k; j++ ) {
