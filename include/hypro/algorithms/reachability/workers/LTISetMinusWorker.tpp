...
REACHABILITY_RESULT LTISetMinusWorker<Representation>::computeTimeSuccessors( const Representation& initialSet, Location<Number> const* loc, OutputIt out ) const {
...
auto LTISetMinusWorker<Representation>::getJumpSuccessors( std::vector<Representation> const& flowpipe, Transition<Number> const* transition ) const -> JumpSuccessorGen {
...
template <class Representation>
struct LTISetMinusWorker<Representation>::EnabledSegmentsGen {
...
template <class Representation>
struct LTISetMinusWorker<Representation>::AggregatedGen {
...
template <class Representation>
struct LTISetMinusWorker<Representation>::JumpSuccessorGen {
...
template <typename Representation>
std::vector<JumpSuccessor<Representation>> LTISetMinusWorker<Representation>::computeJumpSuccessors( std::vector<Representation> const& flowpipe, Location<Number> const* loc ) const {
