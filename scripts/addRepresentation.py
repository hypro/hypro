...
if not os.path.exists(p+ '/' + str(args.name)):
	...
	fillTemplate(os.getcwd()+'/templates/RepresentationTemplate.h', p+ '/' + str(args.name) + '/' + str(args.name) + ".h")
	fillTemplate(os.getcwd()+'/templates/RepresentationTemplateTpp.tpp', p+ '/' + str(args.name) + '/' + str(args.name) + ".tpp")
	fillTemplate(os.getcwd()+'/templates/SettingTemplate.h', p+ '/' + str(args.name) + '/' + str(args.name) + "Setting.h")
	...
	print(str(otherRepresentations))
