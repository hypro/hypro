...
execute_process(
  COMMAND "/usr/bin/git" show-ref release-1.7.0
  WORKING_DIRECTORY "/home/justin/Documents/Masterarbeit/repo/hypro/cmake-build-debug/resources/src/googletest"
...
if("${show_ref_output}" MATCHES "refs/remotes/release-1.7.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "release-1.7.0")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "release-1.7.0")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 release-1.7.0
  WORKING_DIRECTORY "/home/justin/Documents/Masterarbeit/repo/hypro/cmake-build-debug/resources/src/googletest"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'http://github.com/google/googletest.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/justin/Documents/Masterarbeit/repo/hypro/cmake-build-debug/resources/src/googletest/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/justin/Documents/Masterarbeit/repo/hypro/cmake-build-debug/resources/src/googletest/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
