...
macro(load_library group name version)
    ...
    if(${name}_FOUND OR ${LIBNAME}_FOUND)
        ...
        #message(STATUS "libname libraries is: ${${LIBNAME}_LIBRARY_DIRS}")
        message(STATUS "Library_dirs: ${${LIBNAME}_LIBRARY_DIRS}")
        #message(STATUS "Library_dir: ${${LIBNAME}_LIBRARY_DIR}")
        #message(STATUS "Preferred Installation prefix: ${BOOST_ROOT}")
        #message(STATUS "Preferred Include prefix: ${BOOST_INCLUDEDIR}")
        #message(STATUS "Preferred Library prefix: ${BOOST_LIBRARYDIR}")
        ...
        #get_target_property(BLUB ${LIBNAME} LOCATION)
        #message(STATUS "Imported Location: ${BLUB}")
        #message(STATUS "All Includes file: ${${group}_INCLUDE_DIRS}")
