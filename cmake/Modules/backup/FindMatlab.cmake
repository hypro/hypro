...
if(MATLAB_INCLUDE_DIR AND MATLAB_LIBRARIES)
  ...
  if (MATLAB_MX_LIBRARY)
    message(STATUS "\tFound MX lib: " ${MATLAB_MX_LIBRARY})
  endif()
  if (MATLAB_ENG_LIBRARY)
    message(STATUS "\tFound ENG lib: " ${MATLAB_ENG_LIBRARY})
  endif()
  if (MATLAB_MEX_LIBRARY)
    message(STATUS "\tFound MEX lib: " ${MATLAB_MEX_LIBRARY})
  endif()
  if (MATLAB_MAT_LIBRARY)
    message(STATUS "\tFound MAT lib: " ${MATLAB_MAT_LIBRARY})
  endif()
  set(MATLAB_FOUND 1)
endif()
