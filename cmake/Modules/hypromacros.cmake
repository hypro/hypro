...
macro(load_library group name version)
    ...
    if(${name}_FOUND OR ${LIBNAME}_FOUND)
        ...
        if(STATICLIB_SWITCH)
        	if(${name} STREQUAL "carl")
        		list(APPEND ${group}_LIBRARIES_STATIC lib_carl_static)
        		add_imported_library(${LIBNAME} STATIC lib_carl_static "${${LIBNAME}_INCLUDE_DIR}")
        	else()
        	...
        	if(${name} STREQUAL "carl")
        		list(APPEND ${group}_LIBRARIES_DYNAMIC lib_carl)
        		add_imported_library(${LIBNAME} SHARED lib_carl "${${LIBNAME}_INCLUDE_DIR}")
        	else()
...
#
#        #if(NOT(${name} STREQUAL "carl")) #temporary fix!
