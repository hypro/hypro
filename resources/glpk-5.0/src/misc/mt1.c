...
#endif
	  /* Subroutine */ int
	  mt1_( integer* n, integer* p, integer* w, integer* c__,
...
#endif
	  /* Subroutine */ int
	  chmt1_( integer* n, integer* p, integer* w, integer* c__,
...
int mt1( int n, int p[], int w[], int c, int x[], int jck, int xx[],
		 int min[], int psign[], int wsign[], int zsign[] ) { /* solve 0-1 knapsack problem */
