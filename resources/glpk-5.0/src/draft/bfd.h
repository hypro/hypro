...
int bfd_factorize( BFD* bfd, int m, /*const int bh[],*/ int ( *col )( void* info, int j, int ind[], double val[] ), void* info );
...
int bfd_update( BFD* bfd, int j, int len, const int ind[], const double val[] );
