...
#define PRINTF( params )                                         \
	{                                                            \
		if ( colamd_printf != NULL ) (void)colamd_printf params; \
	}
...
#define DEBUG1( params )                           \
	{                                              \
		if ( colamd_debug >= 1 ) PRINTF( params ); \
	}
#define DEBUG2( params )                           \
	{                                              \
		if ( colamd_debug >= 2 ) PRINTF( params ); \
	}
#define DEBUG3( params )                           \
	{                                              \
		if ( colamd_debug >= 3 ) PRINTF( params ); \
	}
#define DEBUG4( params )                           \
	{                                              \
		if ( colamd_debug >= 4 ) PRINTF( params ); \
	}
