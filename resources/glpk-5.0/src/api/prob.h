...
struct glp_prob { /* LP/MIP problem object */
#if 0			  /* 04/IV-2016 */
      unsigned magic;
...
struct GLPROW { /* LP/MIP row (auxiliary variable) */
	int i;
...
struct GLPCOL { /* LP/MIP column (structural variable) */
	int j;
...
struct GLPAIJ { /* constraint coefficient a[i,j] */
	GLPROW* row;
