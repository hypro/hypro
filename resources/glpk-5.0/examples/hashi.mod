/* A solver for the Japanese number-puzzle Hashiwokakero
        ...
        *
        * Sebastian Nowozin
<nowozin@gmail.com>, 13th January 2009
        */

        param n := 25;
        set rows := 1..n;
        set cols := 1..n;
        param givens{rows, cols}, integer, >= 0,
<= 8, default 0;
        ...
        i = k and j
< l and             # Same row and left to right
        card({ (s,t) in V: s = i and t > j and t
< l }) = 0             # No vertex inbetween
        };

        /* Set of feasible vertical edges from (i,j) to (k,l) downwards */
        set Ev := { (i,j,k,l) in { V, V }:
        j = l and i
< k and             # Same column and top to bottom
        card({ (s,t) in V: t = j and s > i and s
                            ...
                            < t and l>t}:
                                ...
                                */
                                ...
                                and card({(i,j,k,l) in Ev: j = col and row >= i and row< k and
                                                                                         xe2[i,j,k,l] = 1}) = 1} '"';
                                printf{0..0: givens[row,col] = 0
                                and card({(i,j,k,l) in Eh: i = row and col >= j and col
                                < l and
                                (xe1[i,j,k,l] = 1 or xe2[i,j,k,l] = 1)}) = 0
                                and card({(i,j,k,l) in Ev: j = col and row >= i and row
                                < k and
                                (xe1[i,j,k,l] = 1 or xe2[i,j,k,l] = 1)}) = 0} " ";
