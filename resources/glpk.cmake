...
#get_target_property(gmp_library_dir GMP_STATIC IMPORTED_LOCATION)
...
add_dependencies(${PROJECT_NAME}-resources GLPK_STATIC)
...
list(APPEND ${PROJECT_NAME}-include-dirs-private ${GLPK_INCLUDE_DIR})
